...
#define sonySysFileCSony		      'SoNy'
#define	sonySysVfsCstmApiCreator	sonySysFileCSony
#define sonySysFileCSystem		    'SsYs'

#define sonySysFileCHRLib		      'SlHr'
#define sonySysFileTHRLib		      sysFileTLibrary
