...
GlobalsInitialize()
{
  ...
  if ((g_config.font.active) && (g_config.gfx.active) && (g_config.menu.active))
    result &= _MnuInitialize();
...
GlobalsTerminate()
{
  ...
  if ((g_config.font.active) && 
      (g_config.gfx.active) && 
      (g_config.menu.active)) _MnuTerminate();
  if ((g_config.font.active) && 
      (g_config.gfx.active) && 
                    ...
                    EventRef inEvent, void *inUserData)
{
  ...
  switch (eventClass)
  {
    ...
    case kEventClassMouse:
         ...
         // unless the window is active; no mouse events please
         if (!g_active) break;
